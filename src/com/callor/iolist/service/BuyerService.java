...
public interface BuyerService {
	...
	// 키보드에서 고객정보를 입력받고 Dao를 통해 Insert 하기
	public void insert();
	
	// 키보드에서 고객정보를 입력받고 Dao를 통해 Update 하기
	public void update();
	
	// Dao를 통해 SelectAll 한 리스트를 Console 에 출력하기
	public void printList();
	
	// 매개변수를 통하여 리스트를 전달받고 Console 에 출력하기
	...
	// 고객 ID를 입력받고, 찾은 고객정보를 return 하기
